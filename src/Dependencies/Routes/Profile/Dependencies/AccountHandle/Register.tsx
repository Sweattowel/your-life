...
export default function Login()
{
    ...
    return(
        <section className="ml-[10vw] bg-gradient-to-b from-HIGHLIGHTB to-WHITE h-[80vh]">
            <div className="bg-WHITE w-[60%] h-[80%] m-auto top-10 relative rounded text-center flex flex-col justify-evenly items-center">
                ...
                <section className="p-5">
                    Want to
                    <Link className="bg-HIGHLIGHTA text-WHITE rounded p-1 ml-2 hover:opacity-90" to={'/Profile'}> Login?</Link>
                </section>            
            </div>
